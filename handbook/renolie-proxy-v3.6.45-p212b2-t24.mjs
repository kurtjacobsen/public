// renolie-proxy-v3.6.45-p212b2-t24.mjs
// Mounts c23c v4 (optional p104) when PDF_ENGINE=c23c
...
app.get('/healthz', (_req,res)=> res.json({
  ok:true, name:'renolie-proxy', version:'v3.6.45-p212b2-t24',
...
(async()=>{
  try {
    if (pdfEngine === 'c23c') {
      const { mountPdfRoutes } = await import('./routes-pdf-c23c.v4.mjs');
      mountPdfRoutes(app);
      pdfMounted = true;
    } else {
